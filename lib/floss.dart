...
/// structure for rendering. It draws inspiration from the
...
/// `Drawing` tree data structure is composed of `CanvasOps` nodes that
/// represent the different types of shapes and composite operations like
