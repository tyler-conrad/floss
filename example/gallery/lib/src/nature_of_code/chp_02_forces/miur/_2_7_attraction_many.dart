...
class AttractionManyModel extends f.Model {
  ...
  AttractionManyModel.init({required super.size})
...
class AttractionManyIur<M extends AttractionManyModel> extends f.IurBase<M>
    implements f.Iur<M> {
  @override
  M update({
    required M model,
    ...
    return AttractionManyModel.update(
      size: size,
      movers: model.movers,
